...
/**
    ...
    class GoogleAuthRepository {
        ...
        suspend fun platformGoogleSignIn(
            ...
            return try {
                ...
                val response = ApiClient.api.platformGoogleSignIn(
    ...
    suspend fun mobileGoogleSignIn(
        ...
        return try {
            ...
            val response = ApiClient.api.mobileGoogleSignIn(
    ...
    suspend fun completeGoogleSignup(
        ...
        return try {
            ...
            val response = ApiClient.api.completeGoogleSignup(
    ...
    suspend fun checkUsername(username: String): Result<CheckUsernameResponse> {
        return try {
            ...
            val response = ApiClient.api.checkUsername(
