        ...
        Column(modifier = Modifier.padding(18.dp)) {
            ...
            if (isLoading && yearly == null) {
                ...
                Column(
                    ...
                    Text(
                        text = "Set a yearly budget for $year to unlock monthly planning and insights.",
                    ...
                    Button(
                        ...
                        Text(
                            text = "Create Budget yearly Budget",
            ...
            Column(
                ...
                if (isYearlyMissing) {
                    ...
                    EmptyState(
                        ...
                        title = "No budget set",
                        subtitle = "No budget set for ${month.toMonthName()} $year.",
                        action = {
                            Button(
                                onClick = onDetails,
                                shape = RoundedCornerShape(12.dp),
